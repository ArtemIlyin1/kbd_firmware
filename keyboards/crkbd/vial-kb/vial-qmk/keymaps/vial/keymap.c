...
[U_BASE] = LAYOUT_split_3x6_3_ex2(
  ...
  //|--------------+--------------+--------------+--------------+--------------+--------------+--------------|  |--------------+--------------+--------------+--------------+--------------+--------------+--------------|
       KC_NO,        LGUI_T(KC_A),  LALT_T(KC_R),  LCTL_T(KC_S),  LSFT_T(KC_T),      KC_G,   TD(U_TD_LANG_SW),       KC_NO,            KC_M,      LSFT_T(KC_N),  LCTL_T(KC_E),  LALT_T(KC_I),  LGUI_T(KC_O),     KC_NO,
  //|--------------+--------------+--------------+--------------+--------------+--------------+--------------'  `--------------+--------------+--------------+--------------+--------------+--------------+--------------|
...
[U_EXTRA] = LAYOUT_split_3x6_3_ex2( //
  ...
  //|--------------+--------------+--------------+--------------+--------------+--------------+--------------|  |--------------+--------------+--------------+--------------+--------------+--------------+--------------|
       RU_SHTI,        LGUI_T(RU_U),  LALT_T(RU_I),  LCTL_T(RU_IE), LSFT_T(RU_O),      RU_A,  TD(U_TD_LANG_SW),         RU_HARD,          RU_EL,     LSFT_T(RU_EN), LCTL_T(RU_TE), LALT_T(RU_ES), LGUI_T(RU_ER),    RU_SHCH,
  //|--------------+--------------+--------------+--------------+--------------+--------------+--------------'  `--------------+--------------+--------------+--------------+--------------+--------------+--------------|
